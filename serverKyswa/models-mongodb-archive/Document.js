...
const documentSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: {
        values: ['PASSEPORT', 'VISA', 'BILLET_ELECTRONIQUE', 'CERTIFICAT', 'PASSEPORT_PHOTO', 'AUTRE'],
        message: 'Le type de document doit être l\'un de: PASSEPORT, VISA, BILLET_ELECTRONIQUE, CERTIFICAT, PASSEPORT_PHOTO, AUTRE',
      },
