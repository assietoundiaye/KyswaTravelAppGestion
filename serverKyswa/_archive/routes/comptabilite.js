...
router.use(protect);
// Seuls le comptable et le DG peuvent accéder à la comptabilité
router.use(requirePermission('comptabilite:read'));
...
router.post('/depenses',
  requirePermission('comptabilite:create'),
  [
...
router.delete('/depenses/:id', requirePermission('comptabilite:delete'), async (req, res) => {
  try {
